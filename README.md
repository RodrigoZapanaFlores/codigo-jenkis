...
# Configurar el `git push` para usar las credenciales de Jenkins
echo "Configurando credenciales para git push..."
git remote set-url origin https://RodrigoZapanaFlores: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@github.com/RodrigoZapanaFlores/TRabajoEntornos1.git
